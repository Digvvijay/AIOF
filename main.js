...
function draw()
{
    ...
    objs=document.getElementById("objs").value;
    ...
    if(status!="")
    {
        ...
        for(i = 0;i < object.length;i++)
        {
            ...
            if(object[i].label==objs)
            {
                document.getElementById("objsr").innerHTML=objs + " is detected";
            }
            else if(object[i].label!=objs)
            {
                document.getElementById("objsr").innerHTML=objs + " isn't detected";
            }
            fill(r,g,b);
